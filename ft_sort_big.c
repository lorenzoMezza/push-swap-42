...
** stack_b is in descending order, so each element from the top of b
** can be placed at the right position in a.
*/
...
** 1. Push 2 elements to b to seed it.
** 2. Repeatedly push the cheapest element from a to b.
** 3. Sort the remaining 3 elements in a with ft_sort_three.
** 4. Reinsert all of b back into a.
** 5. Final rotate to put index 0 on top.
*/
